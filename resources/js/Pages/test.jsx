            ...
            <header id="header" className="header d-flex align-items-center sticky-top">
                ...
                <main className="main">
                    ...
                    <section id="hero" className="hero section">
                        ...
                        <div className="container">
                            <h2 data-aos="fade-up" data-aos-delay="100" className="">Learning Today,<br/>Leading Tomorrow
                            </h2>
                        ...
                        <div className="container">
                            ...
                            <div className="row gy-4">
                                ...
                                <div className="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up"
                                    ...
                                    <ul>
                                        <li><i className="bi bi-check-circle"></i> <span>Ullamco laboris nisi ut aliquip ex ea commodo consequat.</span>
                                        </li>
                                        <li><i className="bi bi-check-circle"></i> <span>Duis aute irure dolor in reprehenderit in voluptate velit.</span>
                                        </li>
                                        <li><i className="bi bi-check-circle"></i> <span>Ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate trideta storacalaperda mastiro dolore eu fugiat nulla pariatur.</span>
                                        </li>
                                    </ul>
                                    <a href="#" className="read-more"><span>Read More</span><i
                                ...
                                <div className="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                                    <div className="why-box">
                                        ...
                                        <div className="text-center">
                                            <a href="#" className="more-btn"><span>Learn More</span> <i
                                ...
                                <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in"
                                    ...
                                    <div className="course-item">
                                        ...
                                        <div className="course-content">
                                            ...
                                            <p className="description">Et architecto provident deleniti facere repellat
                                                nobis iste. Id facere quia quae dolores dolorem tempore.</p>
                                            <div className="trainer d-flex justify-content-between align-items-center">
                                                <div className="trainer-profile d-flex align-items-center">
                                                    <img src="/assets/img/trainers/trainer-1-2.jpg" className="img-fluid"
                                                         alt=""/>
                                ...
                                <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0"
                                    ...
                                    <div className="course-item">
                                        ...
                                        <div className="course-content">
                                            ...
                                            <div className="trainer d-flex justify-content-between align-items-center">
                                                <div className="trainer-profile d-flex align-items-center">
                                                    <img src="/assets/img/trainers/trainer-2-2.jpg" className="img-fluid"
                                                         alt=""/>
                                ...
                                <div className="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0"
                                    ...
                                    <div className="course-item">
                                        ...
                                        <div className="course-content">
                                            ...
                                            <div className="trainer d-flex justify-content-between align-items-center">
                                                <div className="trainer-profile d-flex align-items-center">
                                                    <img src="/assets/img/trainers/trainer-3-2.jpg" className="img-fluid"
                                                         alt=""/>
                ...
                <footer id="footer" className="footer position-relative">
                    ...
                    <div className="container copyright text-center mt-4">
                        <p>© <span>Copyright</span> <strong className="px-1 sitename">Mentor</strong> <span>All Rights Reserved</span>
                        </p>
